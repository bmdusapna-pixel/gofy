          ...
          {banners_first.map((item) => {
            ...
            return (
              <div
                ...
                className="flex gap-2 md:gap-5 w-full rounded-2xl p-5 md:p-10 lg:p-5 items-center"
              >
                <div className="w-full md:w-1/3 flex items-center justify-center">
                  <Badge
                    className="w-16 md:w-20 h-16 md:h-20 rounded-full absolute z-5"
                    style={{ color: item.icon_bg_color }}
                  />
                  <div
                    style={{ backgroundColor: item.icon_bg_color }}
                    className="md:w-14 w-10 z-10 rounded-full p-2 md:h-14 h-10 flex items-center justify-center"
                  >
                    <IconComponent className="w-6 h-6 text-white" />
                  </div>
                </div>
                <div className="w-full md:w-2/3 flex flex-col gap-2">
                  <p className="text-[20px] text-black leading-[30px] font-semibold">
                    {item.title}
                  </p>
                  <p className="text-[16px] text-gray-600 font-semibold leading-[24px]">
                    {item.subtitle}
                  </p>
                </div>
              </div>
