      ...
      <div className="flex flex-col gap-10 w-full">
        ...
        <div className="lg:px-12 px-5 w-full mx-auto flex flex-col gap-10">
          ...
          <div className="w-full overflow-x-hidden relative">
                  ...
                  <div className="w-full border flex lg:flex-row flex-col gap-3 xl:gap-5 border-gray-200 rounded-md p-2">
                    ...
                    <div className="flex flex-col gap-1 py-5 w-full lg:w-1/2 lg:px-0 px-2">
                      ...
                      <div className="flex gap-2 items-center">
                        ...
                        <p className="text-gray-500 text-[16px] line-through leading-[30px] font-semibold">
                          ₹ {product.price + 100}
                        </p>
                      </div>
            ...
            <ChevronLeft
              className="swiper-button-prev-1 absolute left-0 top-32 p-1 w-10 h-10 transform -translate-y-1/2 z-10 bg-[#e9f9fc] text-black rounded-full hover:bg-[#f8f9fa] cursor-pointer opacity-25 hover:opacity-100"
              style={{ boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)" }}
            />
            <ChevronRight
              className="swiper-button-next-1 absolute right-0 top-32 p-1 w-10 h-10 transform -translate-y-1/2 z-10 bg-[#e9f9fc] text-black rounded-full hover:bg-[#f8f9fa] cursor-pointer opacity-25 hover:opacity-100"
              style={{ boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)" }}
            />
          </div>
        </div>
            ...
            <div className="flex lg:flex-row flex-col gap-6 w-full">
              <div className="w-full lg:w-3/4 flex flex-col gap-10">
                ...
                <div className="w-full overflow-x-hidden relative">
                        ...
                        <div className="w-full flex lg:flex-row flex-col gap-5 border border-gray-200 rounded-md p-3 bg-white">
                          ...
                          <div className="lg:w-1/2 w-full flex flex-col gap-3">
                            ...
                            <div className="flex sm:flex-row flex-col lg:flex-col sm:justify-between justify-start w-full">
                              <div className="flex gap-2 items-center">
                                <p className="text-[#198754] text-[22px] leading-[30px] font-semibold">
                                  ₹ {trending.price}
                                </p>
                  ...
                  <ChevronLeft
                    className="swiper-button-prev-2 absolute left-0 top-32 p-1 w-10 h-10 transform -translate-y-1/2 z-10 bg-[#e9f9fc] text-black rounded-full hover:bg-[#f8f9fa] opacity-25 hover:opacity-100 cursor-pointer"
                    style={{ boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)" }}
                  />
                  <ChevronRight
                    className="swiper-button-next-2 absolute right-0 top-32 p-1 w-10 h-10 transform -translate-y-1/2 z-10 bg-[#e9f9fc] text-black rounded-full hover:bg-[#f8f9fa] cursor-pointer opacity-25 hover:opacity-100"
                    style={{ boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)" }}
                  />
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/4 flex flex-col gap-5 overflow-y-scroll h-full sm:h-[50vh] hide-scrollbar">
                {sliding_section.map((item) => (
                  <div
                    className="w-full rounded-2xl flex flex-col gap-5 px-8 py-5"
                  ...
                  >
                    ...
                    <div className="flex sm:flex-row flex-col justify-center sm:justify-between w-full items-center">
                      <button
                        onMouseEnter={() => setSlidingSectionHovered(item._id)}
