      ...
      <div className="w-full lg:px-12 px-5 mx-auto py-10 flex flex-col gap-20">
        <div className="flex lg:flex-row flex-col gap-5 w-full">
          ...
          <div className="lg:w-1/2 w-full flex flex-col gap-3 2xl:gap-8 ">
            <div className="flex w-full items-center">
              ...
              <p className="text-gray-500 text-base leading-[16px]">({toy.review} Customer Reviews)</p>
            </div>
            <p className="text-[32px] md:text-[38px] leading-[48px] md:leading-[57px] font-semibold">{toy.name}</p>
            ...
            <div className="flex gap-3 items-center w-full">
              ...
              <div onClick={()=>addProductToCart(toy)} className="py-2 w-40 rounded-2xl transition-colors duration-300 hover:bg-[#f88e0f] cursor-pointer px-3 bg-[#00bbae] flex gap-3 items-center justify-center">
              ...
              <div onClick={()=>addFavouriteItems(toy)} className="cursor-pointer w-12 h-12 border border-gray-200 flex items-center justify-center rounded-2xl bg-white transition-colors hover:bg-[#00bbae] text-black hover:text-white">
        ...
        <div className="w-full border border-gray-200 rounded-2xl p-6 bg-white relative">
          ...
          <div className="flex flex-col gap-5 w-full">
            <p className="text-[18px] leading-[27px] text-black font-semibold">{toy.review} review for Outdoor Swing Set</p>
            ...
            <Swiper modules={[Autoplay, Navigation]} autoplay={{ delay: 3000, disableOnInteraction: false }} navigation={{ nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" }} breakpoints={{ 0: { slidesPerView: 1, spaceBetween: 20 }, 480: { slidesPerView: 2, spaceBetween: 20 }, 800: { slidesPerView: 2, spaceBetween: 10 }, 1280: { slidesPerView: 3, spaceBetween: 10 }, 1536: { slidesPerView: 4, spaceBetween: 10 } }} loop={true} grabCursor={true}>
              {
                toys_items.map((toy) => (
                  <SwiperSlide key={toy._id}>
                    <Link to={`/products/toys/${toy.url}`} className="w-full border flex md:flex-row flex-col gap-3 xl:gap-5 border-gray-200 rounded-md p-2">
                      <div className="w-full h-60 lg:w-1/2 bg-[#FFC0CB] rounded-md flex items-center justify-center relative">
                        <img src={toy.images[0]} alt="" className="object-contain" />
                      ...
                      <div className="flex flex-col gap-1 py-5 w-full lg:w-1/2 lg:px-0 px-2">
                        <p className="text-[#212529] text-[16px] leading-[24px] opacity-75">{toy.sub_category}</p>
                        <p className="text-[20px] leading-[30px] text-[#212529] font-bold">{toy?.name}</p>
                        <div className="flex lg:flex-row md:flex-col flex-row w-full items-center">
                          ...
                          <p className="text-gray-500 text-base leading-[16px]">({toy.review} Reviews)</p>
                        </div>
                        <p className="text-black text-[20px] leading-[30px] font-semibold">₹ {toy.price}</p>
                        <div className="flex md:flex-col lg:flex-row flex-row gap-5 md:gap-2 lg:gap-5 items-center">
                          <div onClick={(event)=>addProductToCart(toy, event)} className="rounded-full transition-colors duration-300 hover:bg-[#f88e0f] cursor-pointer px-4 py-2 bg-[#00bbae] flex gap-3 items-center justify-center">
                            <ShoppingBasket className="w-5 h-5 text-white" />
                            <p className="text-[16px] leading-[18px] font-semibold text-white">Add to cart</p>
                          </div>
                          <div className="flex gap-5">
                            <div onClick={(event)=>addFavouriteItemsWishList(toy, event)} className="cursor-pointer w-10 border border-gray-200 h-10 flex items-center justify-center rounded-full bg-white transition-colors hover:bg-[#00bbae] text-gray-500 hover:text-white">
                              <Heart className="w-5 h-5" />
                            </div>
                          </div>
                        </div>
